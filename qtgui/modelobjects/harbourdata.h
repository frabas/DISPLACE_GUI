...
public:
    ...
    const vector<int> &get_usual_fgrounds() { return mHarbour->get_usual_fgrounds(); }
    void set_usual_fgrounds(const vector<int> &usual_fgrounds) { mHarbour->set_usual_fgrounds(usual_fgrounds); }
