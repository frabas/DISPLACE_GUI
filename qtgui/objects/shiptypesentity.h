#ifndef SHIPTYPESENTITY_H
#define SHIPTYPESENTITY_H
...
#include <memory>
        ...
        class ShipTypesEntity : public ObjectTreeEntity
        {
            int mGroupIndex;
            QString mLabel;
        ...
        public:
            explicit ShipTypesEntity(ObjectTreeModel *_model, std::shared_ptr<InterestingListWithSpecialValues<int>> list, int idx = -1);

            virtual ObjectTreeModel::Category getCategory() const override {
                return ObjectTreeModel::ShipsTypes;
            }
