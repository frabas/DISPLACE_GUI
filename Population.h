...
public:
    ...
    vector<double> get_tot_N_at_szgroup() const;
    vector<double> get_tot_N_at_szgroup_just_after_redistribution() const;
    vector<double> get_tot_N_at_szgroup_month_minus_1() const;
    vector<double> get_tot_N_at_szgroup_year_minus_1() const;
    vector<double> get_tot_N_at_age() const;
    vector<double> get_tot_N_at_age_last_quarter() const;
    vector<double> get_tot_F_at_age() const;
    vector<double> get_tot_F_at_age_last_quarter() const;
    vector<double> get_tot_M_at_age() const;
    vector<double> get_tot_W_at_age() const;
    vector<double> get_fbar_ages_min_max() const;
    vector<double> get_maturity_at_szgroup() const;
    vector<double> get_fecundity_at_szgroup() const;
    vector<double> get_weight_at_szgroup() const;
    vector<int> get_comcat_at_szgroup() const;
    vector<double> get_M_at_szgroup() const;
    vector<double> get_proprecru_at_szgroup() const;
    double get_SSB() const;
    vector<double> get_param_sr() const;
    ...
    void set_tot_N_at_szgroup(vector <double> _N_at_szgroup);
    void set_tot_N_at_szgroup_just_after_redistribution(vector <double> _N_at_szgroup_just_after_redistribution);
    void set_tot_N_at_szgroup_month_minus_1(vector <double> _N_at_szgroup_month_minus_1);
    void set_tot_N_at_szgroup_year_minus_1(vector <double> _N_at_szgroup_year_minus_1);
    void set_tot_N_at_age(vector <double> _N_at_age);
    void set_tot_N_at_age_last_quarter(vector <double> _N_at_age_last_quarter);
    void set_tot_F_at_age(vector <double> _F_at_age);
    void set_tot_F_at_age_last_quarter(vector<double> _tot_F_at_age_last_quarter);
    void set_tot_M_at_age(vector <double> _M_at_age);
    ...
    void set_landings_so_far(double _landings_so_far); // in weight...
    void set_param_sr(vector <double> _param_sr);
    ...
    void compute_tot_N_and_F_and_M_and_W_at_age(); // do a cumul for F
    double compute_fbar();
    void compute_TAC();
    void clear_tot_F_at_age();  // clear the cumul
    void do_growth(); // apply the size transition matrix
    void add_recruits_from_eggs(); // stock-recruitment relationship via fecundity_at_szgroup
    void add_recruits_from_SR(); // stock-recruitment relationship via fecundity_at_szgroup
    void apply_natural_mortality(); // monthly M on the entire pop (i.e. not spatially disaggregated)
...
private:
    ...
    multimap<int,double> full_spatial_availability; // for sharing the total N by node
