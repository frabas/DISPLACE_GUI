...
public:
        ...
        void set_spe_harbours (const vector<int> &_harbours);
        void set_spe_fgrounds (const vector<int> &_fgrounds);
        void set_spe_fgrounds_init (const vector<int> &_fgrounds_init);
        void set_fgrounds_in_closed_areas (const vector<int> &_fgrounds);
        void set_spe_freq_harbours (const vector<double> &_harbours);
        void set_spe_freq_fgrounds (const vector<double> &_fgrounds);
        void set_spe_freq_fground (int index, double _fground);
        void set_spe_freq_fgrounds_init (const vector<double> &_fgrounds_init);
        void set_fishing_credits (const vector<double> &_fishing_credits);
        void set_spe_cumcatch_fgrounds (const vector<double> &_cumcatch);
        void set_spe_experienced_bycatch_prop_on_fgrounds (const vector<double> &_experienced_bycatch_prop_on_fgrounds);
        void set_spe_cumeffort_fgrounds (const vector<double> &_cumeffort);
        void set_spe_experiencedcpue_fgrounds (const vector<double> &_experiencedcpue);
        void set_spe_betas_per_pop (const vector<double> &_betas_per_pop);
        void set_spe_percent_tac_per_pop (const vector<double> &_tacs_per_pop);
        void set_spe_possible_metiers (const multimap <int, int>  &_possible_metiers);
        void set_spe_freq_possible_metiers (const multimap <int, double>  &_freq_possible_metiers);
		void init_cpue_nodes_species(int nbnodes, int nbspecies);
        void set_cpue_nodes_species(int sp, const vector<double> &newval);
		void init_gshape_cpue_nodes_species(int nbnodes, int nbspecies);
        void set_gshape_cpue_nodes_species(int sp, const vector<double> &newval);
		void init_gscale_cpue_nodes_species(int nbnodes, int nbspecies);
        void set_gscale_cpue_nodes_species(int sp, const vector<double> &newval);
        void set_cumcatch_fgrounds(const vector<double> &newval);
        void set_experienced_bycatch_prop_on_fgrounds(const vector<double> &newval);
        void set_cumcatch_fgrounds_per_pop(const vector<vector<double> > &newval);
        void set_cumeffort_fgrounds(const vector<double> &newval);
        void set_experiencedcpue_fgrounds(const vector<double> &newval);
        void set_experiencedcpue_fgrounds_per_pop(const vector<vector<double> > &newval);
        void set_freq_experiencedcpue_fgrounds(const vector<double> &newval);
        void set_freq_experiencedcpue_fgrounds_per_pop(const vector<vector<double> > &newval);
