...
enum class NationsStat { Catches, Discards, Earnings, ExEarnings,TimeAtSea, Gav, FuelCost, Vpuf, SweptArea, RevenuePerSweptArea,  GVA, GVAPerRevenue,
                   LabourSurplus, GrossProfit,NetProfit, NetProfitMargin, GVAPerFTE, RoFTA, BER, CRBER, NetPresentValue, numTrips, ReasonToGoBack };

enum class VesselsStat { Catches, Discards, Earnings, ExEarnings,TimeAtSea, Gav, FuelCost, Vpuf, SweptArea, RevenuePerSweptArea,  GVA, GVAPerRevenue,
                   LabourSurplus, GrossProfit,NetProfit, NetProfitMargin, GVAPerFTE, RoFTA, BER, CRBER, NetPresentValue, numTrips, ReasonToGoBack };
