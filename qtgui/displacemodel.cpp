...
//TODO: check this!
        ...
        if (binary_search (dyn_alloc_sce.begin(), dyn_alloc_sce.end(), "shared_harbour_knowledge"))
        {
            ...
            //mVessels.at(i)->mVessel->set_metier(  mMetiers[ a_met[0] ]  );
             ...
             //3. get the harbour and associated knowledge
            ...
            vector<double>          experiencedcpue_fgrounds(freq_grounds_from_harbours.size());
            vector<vector<double> > experiencedcpue_fgrounds_per_pop (grounds_from_harbours.size(), a_vector);
            vector<double>          freq_experiencedcpue_fgrounds(freq_grounds_from_harbours.size());
            vector<vector<double> > freq_experiencedcpue_fgrounds_per_pop (grounds_from_harbours.size(), a_vector);
            ...
            // 5- Then, apply changes to the vessel
            ...
            mVessels.at(i)->mVessel->set_cumcatch_fgrounds(experiencedcpue_fgrounds);// re-dimensioned
            ...
            mVessels.at(i)->mVessel->set_experiencedcpue_fgrounds(experiencedcpue_fgrounds); // re-dimensioned
            mVessels.at(i)->mVessel->set_experiencedcpue_fgrounds_per_pop(experiencedcpue_fgrounds_per_pop); // re-dimensioned
            mVessels.at(i)->mVessel->set_freq_experiencedcpue_fgrounds(freq_experiencedcpue_fgrounds); // re-dimensioned
            mVessels.at(i)->mVessel->set_freq_experiencedcpue_fgrounds_per_pop(freq_experiencedcpue_fgrounds_per_pop); // re-dimensioned
