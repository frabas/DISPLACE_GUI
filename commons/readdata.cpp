...
bool read_environment_on_coord(istream &stream, const std::string &separator,   std::vector <std::tuple< double, double, int, int,
...
{
    // Format:
    //"x"                     "y"                     "harb"                  "pt_graph"              "landscapes_code"       "landscape_norm"        "landscape_alpha"
    //"sst_norm"              "sst_alpha"             "salinity"              "salinity_norm"         "salinity_alpha"        "nitrogen"              "nitrogen_norm"
    //"nitrogen_alpha"        "phosphorus"            "phosphorus_norm"       "phosphorus_alpha"      "oxygen"                "oxygen_norm"           "oxygen_alpha"
    //"dissolvedcarbon"       "dissolvedcarbon_norm"  "dissolvedcarbon_alpha"
    ...
    try {
        while (stream) {
            ...
            std::tuple< double, double, int, int,
                    ...
                    double, double, double, double,
                    double, double, double, double,
                    double, double, double, double > a_tuple;
